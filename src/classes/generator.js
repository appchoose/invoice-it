    ...
    if (Array.isArray(tmp)) {
      for (let i = 0; i < tmp.length; i += 1) {
        ...
        tmp[i].total_product_without_taxes = this.formatOutputNumber(tmp[i]
          .price * tmp[i].qt);
        tmp[i].total_product_with_taxes = this.formatOutputNumber(tmp[i]
          .price_ttc * tmp[i].qt);
      ...
      tmp.total_product_without_taxes = this.formatOutputNumber(tmp.price
        * tmp.qt);
      tmp.total_product_with_taxes = this.formatOutputNumber(tmp.price_ttc
        * tmp.qt);
  ...
  _preCompileCommonTranslations() {
    return {
      ...
      table_total_fdp__all: this.formatOutputNumber(this.fdp - this
        .fdpoffered),
      table_total_eee_price: this.formatOutputNumber(this.total_eee_price || 0),
      ...
      table_total_with_taxes_value: this.formatOutputNumber(this
        .total_inc_taxes),
      table_total_with_taxes_value_with_credit: this.formatOutputNumber(this.total_inc_taxes - (this.discount || 0) - (this.credit || 0) + (this.fdp || 0) - (this.fdpoffered || 0)),
